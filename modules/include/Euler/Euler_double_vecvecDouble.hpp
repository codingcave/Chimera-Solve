#ifndef EULER_DOUBLE_VECVECDOUBLE_H
#define EULER_DOUBLE_VECVECDOUBLE_H
...
class Euler_double_vecvecDouble:
    public chimera::simulation::TemplateIntegrator<double, vec_vec_real>
{
    public:
        Euler_double_vecvecDouble(chimera::ParameterTypeSystem* ps, chimera::EntryPoint* init, chimera::simulation::TemplateOdeSystem<double, vec_vec_real>* system, double dt);
        virtual ~Euler_double_vecvecDouble();
    ...
    private:
        ...
        odeint::euler<vec_vec_real>* _euler;
        EulerSystem<double, vec_vec_real>* _system;
        double _time;
        double _endtime;
        double _dt;
        vec_vec_real* _state;
...
#endif // EULER_DOUBLE_VECVECDOUBLE_H
