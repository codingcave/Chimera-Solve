...
namespace chimera {
    ...
    class IConnectEventHandler
    {
        public:
            ...
            virtual void notifyLoad(const std::string& name, EntryPoint* const ep, Module const * const reg) = 0;
            virtual void notifyUnload(const std::string& name, EntryPoint* const ep, Module* const reg) = 0;
